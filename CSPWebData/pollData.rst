...
İlk Veri Setimiz: Birleşik Devletler'de Hava Kirliliği
=======================================================

Keşfedeceğimiz ilk veri setimiz The Guardian’ın bloğundan. Dünyada kirlilik verilerine sahip oldukları tüm şehirlerin büyüleyici bir etkileşimli haritası var: http://www.theguardian.com/news/datablog/interactive/2014/may/08/exposure-air-pollution-city-map

Sadece ABD verilerini kullanacağız. Veri setimizde sütun (‘:’) karakterleriyle ayrılmış üç sütun var:
  - Şehir ve eyaletler virgülle ayrılmış durumda.
  - Çapı 10 mikrometre olan yıllık ortalama miktarlarda parçacıklar, havadaki metreküp (mikro / m3) mikrogramları cinsinden ölçülen kirlilik miktarı. Bu PM 10 olarak kısaltılmıştır.
  - Her metreküp havadaki aynı mikrogramda ölçülen, ortalama mikrometre çapı 2.5 mikrometre (daha küçük) olan yıllık ortalama kirlilik miktarı. Bu PM 2.5 olarak kısaltılmıştır.

İşte verilerin sadece ilk 9 satırı.
...
**Tüm** verileri görmek istiyorsanız, aşağıdaki *Göster* düğmesine tıklayın. Görüntülendiğinde, *Gizle* düğmesini tıklatarak tekrar gizleyebilirsiniz.
...
Dünya Sağlık Örgütü’ne göre, 2.5 mikrometre boyutunda ki kirlilikler daha ölümcüldür, çünkü daha kolay akciğerlerimizin <http://en.wikipedia.org/wiki/Particulates>`_ içine girer. Bunun ne kadar tehlikeli olduğu hakkında bir fikir vermek için, yıllık ortalama 5 µg / m3'lük bir miktar (havadaki metreküp mikrogramı), %13'lük kalp krizi riski ile artmasıyla bağlantılıdır.
