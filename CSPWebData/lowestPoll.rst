...
En düşük PM 2.5 kirlilik değeri nedir?
=====================================

Eğer maksimum kirliliğe sahip olan şehri hesaplayabiliyorsak, minimum kirliliğe sahip olan şehri bulmak da oldukça kolay olmalı. 

Bu bölümde de, daha önce kullandığımız aynı veri dosyasını kullanıyoruz; ancak **tüm** verileri görmek isterseniz aşağıdaki Göster butonuna tıklayabilirsiniz. Dosyayı görüntülediğinizde, Gizle butonuna tıklayarak tekrar gizleyebilirsiniz
...
.. activecode:: min25
   ...
   for satir in satirlar:
       ...
       # eğer mevcut değer minimum değerden küçükse
       if yeni25 < min25:
       
           # yeni minimum bilgiyi kaydet
           minSehir = degerler[0]
           min25 = yeni25
           
   # en küçük PM 2.5 değerini yazdır
   print("En düşük PM 2.5 değeri; ",minSehir," şehrindeki ",min25," değeridir.")
   
.. mchoice:: 18_5_1_min25
   :answer_a: Evet
   :answer_b: Hayır
   :correct: b
   :feedback_a: Bu kod, gerçek minimum değer 500’den az olduğu sürece çalışacaktır.  
   :feedback_b: Gerçek minimum değer 500’den büyük olursa, bu kod çalışmayacaktır.

    Bu kod, minimum PM 2.5 değerini bulmak için her zaman çalışacak mıdır?
   


Şimdi de; en küçük PM 10 değerine sahip olan şehri bulmak için gereken kodu yazabilir misiniz? Aşağıdaki kodda, yorum sembolü (``#``) ile başlayan satırları değiştirin. 
...
.. activecode:: min10_ex
   ...
   for satir in satirlar: 
       ...
       if yeni10 < min10:
           ...
           # minimum değere sahip şehir ve eyaleti kaydet
           # minimum PM 10 değerini kaydet
           print("En düşük PM 10 değeri; ",minSehir," şehrindeki ",min10," değeridir.")
          

.. mchoice:: 18_5_2_min10
   :answer_a: Aynı şehir, minimum PM 2.5 ve minimum PM 10 değerlerine sahiptir.  
   :answer_b: İki şehir farklı eyaletlerdedir, fakat her ikisi de doğuda yer alır.   
   :answer_c: İki şehir farklı eyaletlerdedir, fakat her ikisi de batıda yer alır.   
   :correct: c
   :feedback_a: Programınızı PM 10 değeri için kontrol edin.
   :feedback_b: En düşük PM 2.5 değerini bulduran ilk programı sen çalıştırmadın, değil mi?
   :feedback_c: Minimum değerler iki farklı şehire aittir, ancak iki şehir de batıdadır.

   Minimum PM 2.5 ve PM 10 değerlerine sahip olan şehirler için aşağıdakilerden hangisi doğrudur? 
   
.. parsonsprob:: 18_5_1_minPM25

   Aşağıdaki program, bulunan minimum PM 2.5 kirlilik değerini yazdırır ancak kodlar karışık sırada verilmiştir. Kod bloklarını sol sütundan sağ sütuna sürükleyin ve doğru sıraya göre yerleştirin. Sonra Check Me butonuna tıklayarak doğru şekilde yapıp yapmadığınızı kontrol edin. Satırlardan herhangi birisi yanlış sırada ise ya da yanlış girintiye sahip ise ekranda bir uyarı mesajı göreceksiniz.
   -----
   # bütün satırları oku
   dosya = open("uspoll.txt","r")
   satirlar = dosya.readlines()
